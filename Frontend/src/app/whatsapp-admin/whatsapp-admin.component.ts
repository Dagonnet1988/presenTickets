...
export class WhatsAppAdminComponent implements OnInit {
  ...
  systemSettings: any = {
    ...
    max_pending_user_tickets: 3, // tope de "Esperando respuesta del usuario" para bloquear creación
    ...
    try {
      ...
      if (settings) {
        ...
        this.systemSettings = {
          ...
          max_pending_user_tickets: settings.max_pending_user_tickets ?? 3,
  ...
  async saveSystemSettings() {
    ...
    try {
      ...
      const globalSettings = {
        ...
        max_pending_user_tickets: Math.min(50, Math.max(1, Number(this.systemSettings.max_pending_user_tickets) || 3)),
